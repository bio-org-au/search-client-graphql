...
module NamesHelper
  ...
  def simple_list_url(search_term)
    "/names/search?utf8=✓&q=#{search_term}&list_or_count=list&limit_per_page_for_list=50&limit_per_page_for_details=10&search=Search"
  end

  def simple_list_in_family_order_url(search_term)
    "/names/search?utf8=✓&q=#{search_term}&list_or_count=list&limit_per_page_for_list=50&limit_per_page_for_details=10&show_family=1&search=Search"
  end

  def simple_list_with_links_url(search_term)
    "/names/search?utf8=✓&q=#{search_term}&list_or_count=list&limit_per_page_for_list=50&limit_per_page_for_details=10&show_links=1&search=Search"
  end

  def simple_list_with_links_and_details_url(search_term)
    "/names/search?utf8=✓&q=#{search_term}&list_or_count=list&limit_per_page_for_list=50&limit_per_page_for_details=10&show_details=1&show_links=1&search=Search"
  end
end
