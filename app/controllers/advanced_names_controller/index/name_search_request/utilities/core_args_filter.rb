...
class AdvancedNamesController::Index::NameSearchRequest::Utilities::CoreArgsFilter
  ...
  def filter_raw_query_string
    @raw_query_string =
      @raw_query_string.delete(' ')
                       ...
                       .sub(/the_author_abbrev_placeholder/, @client_request.author_abbrev || '')
                       .sub(/ex_author_abbrev_placeholder/, @client_request.ex_author_abbrev || '')
                       .sub(/the_base_author_abbrev_placeholder/, @client_request.base_author_abbrev || '')
                       .sub(/ex_base_author_abbrev_placeholder/, @client_request.ex_base_author_abbrev || '')
